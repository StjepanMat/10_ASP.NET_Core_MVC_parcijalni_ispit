...
namespace Ispit.Todo.Controllers
{
    ...
    public class TaskController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TodoListId,SingleTask,Completed")] Ispit.Todo.Models.Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TodoListId,SingleTask,Completed")] Ispit.Todo.Models.Task task)
        {
            if (id != task.Id)
            {
                return NotFound();
